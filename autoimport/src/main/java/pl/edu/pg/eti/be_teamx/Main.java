package pl.edu.pg.eti.be_teamx;
...
public class Main {
    ...
    private void importFile(String path, List<String> columns, int maxTimeForImport, int typeId) {
        ...
        // select buttons
        try {
            driver.findElement(By.xpath("//*[@id=\"main-div\"]/div[2]/div[1]/div/div[2]/div/div/div[1]/form/div/div[1]/div[12]"))
        ...
        driver.findElement(By.xpath("//*[@id=\"main-div\"]/div[2]/div[1]/div/div[2]/div/div/div[1]/form/div/div[2]/div/button")).click();
